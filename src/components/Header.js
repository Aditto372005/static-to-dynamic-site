    ...
    <header class="header">
      <div class="flex items-center justify-between px-4 w-full">
        <div class="flex items-center">
          <button class="button button-m p-2 sm:hidden sidebar-toggle" type="button">
            <svg class="icon text-secondary size-5" viewBox="0 0 32 32">
              <path d="M4 8.00684H28V11.3402H4V8.00684ZM4 14.6735H28V18.0068H4V14.6735ZM4 21.3402H28V24.6735H4V21.3402Z"></path>
            </svg>
          </button>
          <div class="relative z-10 flex h-full w-60 flex-none items-center px-4">
            <button class="button button-m flex-none rounded-lg bg-layer5 size-10 p-0 sidebar-toggle" type="button">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 32 32" class="h-7 w-7 size-6">
                <rect width="19.386" height="3.497" x="5.282" y="5.58" rx=".6" class="fill-secondary"></rect>
                <rect width="13.879" height="3.497" x="5.925" y="13.83" rx=".6" class="fill-secondary"></rect>
                <rect width="19.386" height="3.497" x="5.282" y="22.08" rx=".6" class="fill-secondary"></rect>
                <path class="fill-brand" d="M27.797 14.714a1 1 0 0 1 0 1.728l-4.178 2.432a1 1 0 0 1-1.503-.864v-4.863a1 1 0 0 1 1.503-.865l4.178 2.432Z"></path>
              </svg>
            </button>
            <img alt="logo" src="https://bc.game/assets/logo/logo_w.png" class="ml-5 h-8 cursor-pointer w-auto">
          </div>
          <div class="relative h-full w-full px-4 mx-auto max-w-[1248px]">
            <div class="absolute left-0 top-0 flex size-full items-center overflow-hidden px-3 justify-end">
              <button class="button button-m rounded-lg bg-layer5 size-10 p-0" type="button">
                <svg xmlns="http://www.w3.org/2000/svg" class="size-6 fill-secondary" viewBox="0 0 24 24">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M14.1018 16.3007C12.8835 17.2777 11.3369 17.8621 9.6537 17.8621C5.72399 17.8621 2.53833 14.6764 2.53833 10.7467C2.53833 6.81701 5.72399 3.63135 9.6537 3.63135C13.5834 3.63135 16.7691 6.81701 16.7691 10.7467C16.7691 12.4471 16.1726 14.0082 15.1775 15.2322L15.9161 15.9708L14.844 17.0429L14.1018 16.3007ZM14.502 10.7466C14.502 13.4242 12.3313 15.5948 9.65371 15.5948C6.9761 15.5948 4.80546 13.4242 4.80546 10.7466C4.80546 8.06896 6.9761 5.89833 9.65371 5.89833C12.3313 5.89833 14.502 8.06896 14.502 10.7466Z"></path>
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M18.7113 21.0375C18.5768 21.172 18.3587 21.1717 18.2246 21.0368L14.7097 17.5C14.5763 17.3657 14.5766 17.1487 14.7105 17.0148L15.8997 15.8256C16.0342 15.6911 16.2524 15.6915 16.3864 15.8264L19.9013 19.3631C20.0348 19.4974 20.0345 19.7144 19.9006 19.8483L18.7113 21.0375Z"></path>
